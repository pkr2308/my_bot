...
: ${AMENT_CURRENT_PREFIX:="/home/fe25/pranav_bot_ros2_jazzy/install/new_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/new_bot/environment/library_path.sh"
